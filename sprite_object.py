...
class SpriteObject:
    def __init__(
        self, game, path="resources/sprites/static/candlebra.png", pos=(1, 1), scale=1.0, shift=0.0
    ):
        self.game = game
...
class AnimatedSprite(SpriteObject):
    def __init__(self, game, path="resources/sprites/animated_sprites/test/0.png", pos=(1, 1), scale=1, shift=0.15, animation_time = 120):
